        ...
        <div x-data="searchApp()" x-init="search(); initializeQrScanner()" class="relative mt-12 bottom-8">
            ...
            <div class="hidden md:flex justify-start h-12">
                ...
                <div class="flex justify-between">
                    <button @click="resetFilter()" class="hidden md:block bg-gray-500 text-white py-1 px-2 ml-2 h-9 text-xs rounded-md hover:bg-gray-600">
                        Reset
                    </button>
                </div>
            ...
            <div class="overflow-x-auto shadow-md rounded-t-lg overscroll-x-none transition-shadow duration-200 ease-in-out shadow hover:shadow-2xl hover:shadow-header-2">
                <table class="w-full text-left rtl:text-right font-roboto">
                    <thead class="text-sm mobile:text-xs uppercase whitespace-nowrap bg-header-2 text-center bg-opacity-40 text-gray-500 shadow-inner">
                        <tr>
