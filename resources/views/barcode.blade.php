...
<body>
    <div style="width: 100%; max-width: 640px; margin: 0 auto; margin-top: 1rem; background-color: #faf8fc;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="border: 2px dashed #a8a7a9; padding: 0.5rem; text-align: center;">
                    ...
                    <div style="margin: 0.5rem 0; display: flex; justify-content: center; width: 100%; text-align: center;">
                        <div style="display: inline-block;">
                            {!! $item['barcodeHtml'] !!}
                        </div>
                    </div>
                    <p style="font-size: 10px;">{{ $item['seri']}}</p>
                </td>
                @endforeach
            </tr>
            @endforeach
