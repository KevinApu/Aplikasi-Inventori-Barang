...
class BarangMasukController extends Controller
{
    ...
    {
        $barangmasuk = StokGudangModel::where('pop', Auth::user()->KLModel->pop)->get();
    ...
    public function kategori(Request $request)
    {
        ...
        $request->validate([
            'kategori_baru' => [
                'required',
                Rule::unique('kategori', 'kategori')->where('pop', Auth::user()->KLModel->pop),
            ],
        ], [
    ...
    public function namabarang(Request $request)
    {
        $request->validate([
            'namabarang_baru' => [
                'required',
                Rule::unique('nama_barang', 'nama_barang')->where('pop', Auth::user()->KLModel->pop),
            ],
        ], [
    ...
    {
        $kategoris = kategori::where('pop', Auth::user()->KLModel->pop)->get();
        $namabarang = nama_barang::where('pop', Auth::user()->KLModel->pop)->get();
